...
const STRINGS = {
  en: {
    ...
    // Job enum labels (Strapi enums are stored in English; displayed via t()).
    "job.enum.Christchurch": "Christchurch",
    "job.enum.North Sydney": "North Sydney",
    "job.enum.Yokohama": "Yokohama",
    "job.enum.Any location": "Any location",
    "job.enum.Full-time": "Full-time",
    "job.enum.Part-time": "Part-time",
    "job.enum.Contract": "Contract",
    "job.enum.Internship": "Internship",
  ...
  ja: {
    ...
    "job.enum.Christchurch": "クライストチャーチ",
    "job.enum.North Sydney": "ノースシドニー",
    "job.enum.Yokohama": "横浜",
    "job.enum.Any location": "勤務地不問",
    "job.enum.Full-time": "フルタイム",
    "job.enum.Part-time": "パートタイム",
    "job.enum.Contract": "契約",
    "job.enum.Internship": "インターン",
