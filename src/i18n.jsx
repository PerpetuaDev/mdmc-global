...
const STRINGS = {
  en: {
    ...
    "jp.about.greeting.p3": "We see design as a mirror of how a company carries itself. We're not here for short-term polish — we're here to do work that still holds value ten years from now. We look forward to working with you.",
    "jp.about.signature.role": "Lead, MDMC Yokohama",
    "jp.about.signature.name": "Hikaru Suzuki",
    "jp.about.signature.romaji": "鈴木 ひかる",

    "jp.about.eyebrow.overview": "Company overview",
    "jp.about.overview.title": "Company Profile",
    "jp.about.fact.shogo": "Name",
    "jp.about.fact.shogo.v": "MDMC Japan Inc.\n株式会社MDMC ジャパン",
    "jp.about.fact.setsuritsu": "Established",
    "jp.about.fact.setsuritsu.v": "April 2017 (MDMC group)\nSeptember 2021 (Yokohama office)",
    "jp.about.fact.daihyo": "Representative",
    "jp.about.fact.daihyo.v": "Hikaru Suzuki, Lead, Yokohama Office",
    "jp.about.fact.shihon": "Capital",
    "jp.about.fact.shihon.v": "JPY 10,000,000",
    "jp.about.fact.jusho": "Registered office",
    "jp.about.fact.jusho.v": "3-30-1 Tokiwa-cho, Naka Ward, Yokohama,\nKanagawa 231-0014, Japan",
    "jp.about.fact.gyomu": "Services",
    "jp.about.fact.gyomu.v": "Brand identity\nProduct & service design\nWebsite design and build\nPackaging\nWayfinding",
    "jp.about.fact.torihiki": "Sectors",
    "jp.about.fact.torihiki.v": "Finance, healthcare, food, and the public sector — from Series A startups through listed companies",

    "jp.about.eyebrow.location": "Visit",
    "jp.about.location.title": "Yokohama studio",
    "jp.about.location.address": "Address",
    "jp.about.location.address.v": "3-30-1 Tokiwa-cho, Naka Ward,\nYokohama, Kanagawa 231-0014, Japan",
    "jp.about.location.access": "Getting here",
    "jp.about.location.access.v": "4 min from Nihon-odori Stn. (Minatomirai Line), exit 3\n7 min from Kannai Stn. (JR Negishi Line), north exit",
    "jp.about.location.contact": "Contact",
    "jp.about.location.contact.v": "jp@mdmc.studio\n+81 80 7823 9592",
    "jp.about.location.directions": "Open in Google Maps",
  },
  ...
  ja: {
    ...
    "jp.about.signature.role": "MDMC 横浜オフィス代表",
    "jp.about.signature.name": "鈴木 ひかる",
    "jp.about.signature.romaji": "Hikaru Suzuki",

    "jp.about.eyebrow.overview": "会社概要",
    "jp.about.overview.title": "Company Profile",
    "jp.about.fact.shogo": "商号",
    "jp.about.fact.shogo.v": "株式会社MDMC ジャパン\nMDMC Japan Inc.",
    "jp.about.fact.setsuritsu": "設立",
    "jp.about.fact.setsuritsu.v": "2017年4月(MDMC本体)\n2021年9月(横浜オフィス開設)",
    "jp.about.fact.daihyo": "代表者",
    "jp.about.fact.daihyo.v": "鈴木 ひかる(横浜オフィス代表)",
    "jp.about.fact.shihon": "資本金",
    "jp.about.fact.shihon.v": "1,000万円",
    "jp.about.fact.jusho": "本社所在地",
    "jp.about.fact.jusho.v": "〒231-0014\n神奈川県横浜市中区常盤町3丁目30-1",
    "jp.about.fact.gyomu": "業務内容",
    "jp.about.fact.gyomu.v": "ブランドアイデンティティ設計\nプロダクト・サービスデザイン\nウェブサイト企画・制作\nパッケージデザイン\nサイン計画",
    "jp.about.fact.torihiki": "主要取引先",
    "jp.about.fact.torihiki.v": "金融、医療、食品、公共セクターを中心に、シリーズA〜Cのスタートアップから上場企業まで",

    "jp.about.eyebrow.location": "アクセス",
    "jp.about.location.title": "横浜オフィス",
    "jp.about.location.address": "所在地",
    "jp.about.location.address.v": "〒231-0014\n神奈川県横浜市中区常盤町3丁目30-1",
    "jp.about.location.access": "交通",
    "jp.about.location.access.v": "みなとみらい線「日本大通り」駅 3番出口より徒歩4分\nJR根岸線「関内」駅 北口より徒歩7分",
