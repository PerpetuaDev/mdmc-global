...
const STRINGS = {
  en: {
    ...
    "jp.about.signature.role": "CEO, MDMC Japan",
    "jp.about.signature.name": "Liam Finlayson",
    "jp.about.signature.romaji": "リアム・フィンレイソン",
    ...
    "jp.about.location.address.v": "5-57-2 Kitanakadori, Naka Ward\nYokohama, Kanagawa 231-0003, Japan\nKITANAKA BRICK & WHITE South, 2F",
    "jp.about.location.access": "Getting here",
    "jp.about.location.access.v": "1 min walk from Bashamichi Stn., exit 4 (Minatomirai Line)\n10 min walk from JR Sakuragicho Stn.\n10 min walk from JR Kannai Stn.",
  ...
  ja: {
    ...
    "jp.about.fact.daihyo.v": "リアム・フィンレイソン(代表取締役)",
